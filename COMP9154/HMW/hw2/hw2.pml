...
proctype P() {
    ...
    :: non_critical_section();
        ...
        //Check previous proc-next proc sequentially.
        do
        :: wantq -> 
            if
            :: turn != 0 -> 
...
/*
    The verification option used are 
        Safety:
        ...
        Claim:
            use claims (with ltl claims listed below)

    Result:
        Mutual exclusion and eventual entry were both violated.
*/
