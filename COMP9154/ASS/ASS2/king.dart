...
void general(GeneralPort main) async {
  ...
  for (int r = 0; r < NUM_TRAITORS + 1; r++) {
    ...
    // print("$id round $r: myMojo: $myMojority, mojoCounts: $votesMajority");
    ...
    if (r == id) {
      ...
      next2 = false;
      // print("$id round $r King's plan: $kingPlan");

      if (votesMajority > (NUM_GENERALS + 1) / 2) {
        plan[id] = myMojority;
      } else {
        plan[id] = kingPlan;
      }
    ...
    myplan = plan[id];
    // print("General $id: Rount: $r, My plan: $myplan");
